...
if(isset($_POST['delete'])){
   ...
   $message[] = 'Suppression d\'un élément de liste de favoris';
}
...
<h1 class="heading">Votre liste de favoris</h1>
...
<form action="" method="post" class="box">
   ...
   <input type="submit" value="Supprimer l'article" onclick="return confirm('Supprimer de la liste des favoris ?');"
...
<?php
   ...
   echo '<p class="empty">Votre liste de favoris est vide</p>';
}
?>
...
<div class="grand-total">
   ...
   onclick="return confirm('Supprimer tout de la liste des favoris ?');">Tout supprimer</a>
</div>
